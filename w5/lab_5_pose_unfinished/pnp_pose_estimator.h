#ifndef LAB_5_POSE_PNP_POSE_ESTIMATOR_H
#define LAB_5_POSE_PNP_POSE_ESTIMATOR_H
...
public:
  ...
  explicit PnPPoseEstimator(const Eigen::Matrix3d& K);
...
#endif //LAB_5_POSE_PNP_POSE_ESTIMATOR_H