...
void lab3()
{
  ...
  // When the second argument is true, additonal debug figures are shown.
  ...
  for (;;)
  {
    ...
    // Todo: Finish CircleEstimator (steps 1-7).
    ...
    // Measure how long the processing takes.
    // Todo: Finish CircleEstimator (step 8).
    start = Clock::now();
