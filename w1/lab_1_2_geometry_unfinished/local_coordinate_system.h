#ifndef LAB_1_2_GEOMETRY_LOCAL_COORDINATE_SYSTEM_H
#define LAB_1_2_GEOMETRY_LOCAL_COORDINATE_SYSTEM_H
...
private:
  GeographicLib::LocalCartesian epe_;
};

#endif //LAB_1_2_GEOMETRY_LOCAL_COORDINATE_SYSTEM_H
